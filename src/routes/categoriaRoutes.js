...
router.get("/",
	...
	/* #swagger.responses[200] = { description: 'Categorias retornadas com sucesso.', schema: [{ id: 1, nome: 'Bebidas' }] } */
...
router.post("/", rotaProtegida,
	...
	/* #swagger.parameters['body'] = { in: 'body', required: true, schema: { $nome: 'Bebidas' } } */
